...
unsigned int nTargetSpacing = 2.5 * 60; // 2.5 minutes
...
const string strMessageMagic = "SquallCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SquallCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "October 02, 2014";
        CTransaction txNew;
        txNew.nTime = 1412275964;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1412275964;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4645709;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x45fa221945f7120cb40fe3b58559d70aa5d1de30ca0017ae5dba759baddbbf3d"));
        block.print();
